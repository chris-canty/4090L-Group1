...
@onready var shatter = load("res://Scenes/Cards/shatter.tscn").instantiate()
...
func enemy_ai(combatants: Array):
	...
	Slime Skills:
		...
		Chill: 0 MP - -25% next outgoing Attack
		Shatter: 3 MP - 12 Ice Damage + 30% next Incoming Attack
